#ifndef UTXOZ_FLATMAP_DETAIL_MULX_HPP
#define UTXOZ_FLATMAP_DETAIL_MULX_HPP
...
#define UTXOZ_FLATMAP_64B_ARCHITECTURE /* >64 bits assumed as 64 bits */
#endif
#elif defined(UINTPTR_MAX) /* used as proxy for std::size_t */
#if ((((UINTPTR_MAX >> 16) >> 16) >> 16) >> 15) != 0
#define UTXOZ_FLATMAP_64B_ARCHITECTURE
#endif
#endif

inline std::size_t mulx( std::size_t x ) noexcept
{
#if defined(UTXOZ_FLATMAP_64B_ARCHITECTURE)
...
#ifdef UTXOZ_FLATMAP_64B_ARCHITECTURE
#undef UTXOZ_FLATMAP_64B_ARCHITECTURE
#endif
...
#endif // #ifndef UTXOZ_FLATMAP_DETAIL_MULX_HPP
