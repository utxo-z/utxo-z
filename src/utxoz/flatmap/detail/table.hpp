...
#ifndef UTXOZ_FLATMAP_DETAIL_FOA_TABLE_HPP
#define UTXOZ_FLATMAP_DETAIL_FOA_TABLE_HPP

#include <boost/assert.hpp>
#include <boost/config.hpp>
#include <boost/config/workaround.hpp>
#include <boost/core/serialization.hpp>
#include <utxoz/flatmap/detail/core.hpp>
 ...
 * (utxoz::flatmap_(flat|node)_(map|set) wrappers complete it as
 * appropriate).
 *
 ...
 * checking is done by utxoz::flatmap_(flat|node)_(map|set).
 */
...
private:
      ...
      size_ctrl_type{x.size_ctrl.ml,x.size_ctrl.size}}
  {
    ...
    x.size_ctrl.size=0;
    UTXOZ_FLATMAP_SWAP_STATS(this->cstats,x.cstats);
  }
