...
#ifndef UTXOZ_FLATMAP_DETAIL_FOA_REENTRANCY_CHECK_HPP
#define UTXOZ_FLATMAP_DETAIL_FOA_REENTRANCY_CHECK_HPP

#include <boost/assert.hpp>
#include <utility>

#if !defined(UTXOZ_FLATMAP_DISABLE_REENTRANCY_CHECK)&& \
    !defined(BOOST_ASSERT_IS_VOID)
#define UTXOZ_FLATMAP_REENTRANCY_CHECK
#endif
...
#if defined(UTXOZ_FLATMAP_REENTRANCY_CHECK)
