...
#ifndef UTXOZ_FLATMAP_DETAIL_TYPE_TRAITS_HPP
#define UTXOZ_FLATMAP_DETAIL_TYPE_TRAITS_HPP
...
// UTXOZ_FLATMAP_TEMPLATE_DEDUCTION_GUIDES

#if !defined(UTXOZ_FLATMAP_TEMPLATE_DEDUCTION_GUIDES)
#if !defined(BOOST_NO_CXX17_DEDUCTION_GUIDES)
#define UTXOZ_FLATMAP_TEMPLATE_DEDUCTION_GUIDES 1
#endif
#endif

#if !defined(UTXOZ_FLATMAP_TEMPLATE_DEDUCTION_GUIDES)
#define UTXOZ_FLATMAP_TEMPLATE_DEDUCTION_GUIDES 0
#endif
  ...
  namespace flatmap {
    namespace detail {
      ...
      struct is_transparent<T,
        utxoz::flatmap::detail::void_t<typename T::is_transparent> >
      ...
      struct is_allocator<A,
        utxoz::flatmap::detail::void_t<typename A::value_type,
...
#endif // UTXOZ_FLATMAP_DETAIL_TYPE_TRAITS_HPP
