#ifndef UTXOZ_FLATMAP_DETAIL_FOA_RW_SPINLOCK_HPP_INCLUDED
#define UTXOZ_FLATMAP_DETAIL_FOA_RW_SPINLOCK_HPP_INCLUDED
...
#endif // UTXOZ_FLATMAP_DETAIL_FOA_RW_SPINLOCK_HPP_INCLUDED
