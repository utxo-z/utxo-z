...
#ifndef UTXOZ_FLATMAP_DETAIL_UNORDERED_PRINTERS_HPP
#define UTXOZ_FLATMAP_DETAIL_UNORDERED_PRINTERS_HPP
...
__asm__(".pushsection \".debug_gdb_scripts\", \"MS\",%progbits,1\n"
        ".ascii \"\\4gdb.inlined-script.UTXOZ_FLATMAP_DETAIL_UNORDERED_PRINTERS_HPP\\n\"\n"
        ...
        ".ascii \"        if f\\\"{e.type.strip_typedefs()}\\\".startswith(\\\"utxoz::flatmap::detail::foa::element_type<\\\"):\\n\"\n"
        ".ascii \"            return e[\\\"p\\\"]\\n\"\n"
        ".ascii \"        else:\\n\"\n"
        ".ascii \"            return e\\n\"\n"
        ...
        ".ascii \"        self.name = self.name.replace(\\\"utxoz::flatmap::\\\", \\\"boost::\\\")\\n\"\n"
        ...
        ".ascii \"            sequence_stats_data = gdb.lookup_type(\\\"utxoz::flatmap::detail::foa::sequence_stats_data\\\")\\n\"\n"
        ...
        ".ascii \"    add_template_printer(\\\"utxoz::flatmap::unordered_map\\\", BoostUnorderedFcaPrinter)\\n\"\n"
        ".ascii \"    add_template_printer(\\\"utxoz::flatmap::unordered_multimap\\\", BoostUnorderedFcaPrinter)\\n\"\n"
        ".ascii \"    add_template_printer(\\\"utxoz::flatmap::unordered_set\\\", BoostUnorderedFcaPrinter)\\n\"\n"
        ".ascii \"    add_template_printer(\\\"utxoz::flatmap::unordered_multiset\\\", BoostUnorderedFcaPrinter)\\n\"\n"

        ".ascii \"    add_template_printer(\\\"utxoz::flatmap::detail::iterator_detail::iterator\\\", BoostUnorderedFcaIteratorPrinter)\\n\"\n"
        ".ascii \"    add_template_printer(\\\"utxoz::flatmap::detail::iterator_detail::c_iterator\\\", BoostUnorderedFcaIteratorPrinter)\\n\"\n"

        ".ascii \"    add_template_printer(\\\"utxoz::flatmap::mmap_flat_map\\\", BoostUnorderedFoaPrinter)\\n\"\n"
        ".ascii \"    add_template_printer(\\\"utxoz::flatmap::unordered_flat_set\\\", BoostUnorderedFoaPrinter)\\n\"\n"
        ".ascii \"    add_template_printer(\\\"utxoz::flatmap::unordered_node_map\\\", BoostUnorderedFoaPrinter)\\n\"\n"
        ".ascii \"    add_template_printer(\\\"utxoz::flatmap::unordered_node_set\\\", BoostUnorderedFoaPrinter)\\n\"\n"
        ".ascii \"    add_template_printer(\\\"utxoz::flatmap::concurrent_flat_map\\\", BoostUnorderedFoaPrinter)\\n\"\n"
        ".ascii \"    add_template_printer(\\\"utxoz::flatmap::concurrent_flat_set\\\", BoostUnorderedFoaPrinter)\\n\"\n"
        ".ascii \"    add_template_printer(\\\"utxoz::flatmap::concurrent_node_map\\\", BoostUnorderedFoaPrinter)\\n\"\n"
        ".ascii \"    add_template_printer(\\\"utxoz::flatmap::concurrent_node_set\\\", BoostUnorderedFoaPrinter)\\n\"\n"

        ".ascii \"    add_template_printer(\\\"utxoz::flatmap::detail::foa::table_iterator\\\", BoostUnorderedFoaIteratorPrinter)\\n\"\n"

        ".ascii \"    add_concrete_printer(\\\"utxoz::flatmap::detail::foa::table_core_cumulative_stats\\\", BoostUnorderedFoaTableCoreCumulativeStatsPrinter)\\n\"\n"
        ".ascii \"    add_template_printer(\\\"utxoz::flatmap::detail::foa::cumulative_stats\\\", BoostUnorderedFoaCumulativeStatsPrinter)\\n\"\n"
        ".ascii \"    add_template_printer(\\\"utxoz::flatmap::detail::foa::concurrent_cumulative_stats\\\", BoostUnorderedFoaCumulativeStatsPrinter)\\n\"\n"
        ...
        ".ascii \"        return gdb.lookup_type(\\\"utxoz::flatmap::detail::foa::table_core_cumulative_stats\\\")\\n\"\n"

        ".ascii \"    def __call__(self, obj):\\n\"\n"
        ".ascii \"        try:\\n\"\n"
        ".ascii \"            return obj[\\\"table_\\\"][\\\"cstats\\\"]\\n\"\n"
        ".ascii \"        except gdb.error:\\n\"\n"
        ".ascii \"            print(\\\"Error: Binary was compiled without stats. Recompile with `UTXOZ_FLATMAP_ENABLE_STATS` defined.\\\")\\n\"\n"
        ".ascii \"            return\\n\"\n"
        ...
        ".ascii \"        regex = \\\"^utxoz::flatmap::(unordered|concurrent)_(flat|node)_(map|set)$\\\"\\n\"\n"
...
#endif // !defined(UTXOZ_FLATMAP_DETAIL_UNORDERED_PRINTERS_HPP)
