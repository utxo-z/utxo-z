...
#ifndef UTXOZ_FLATMAP_DETAIL_ALLOCATOR_CONSTRUCTED_HPP
#define UTXOZ_FLATMAP_DETAIL_ALLOCATOR_CONSTRUCTED_HPP

#include <boost/core/allocator_traits.hpp>
#include <utxoz/flatmap/detail/opt_storage.hpp>
