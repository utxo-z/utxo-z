...
#ifndef UTXOZ_FLATMAP_CONCURRENT_FLAT_MAP_FWD_HPP
#define UTXOZ_FLATMAP_CONCURRENT_FLAT_MAP_FWD_HPP
...
namespace utxoz {
  namespace flatmap {
    ...
    namespace pmr {
      template <class Key, class T, class Hash = boost::hash<Key>,
        class Pred = std::equal_to<Key> >
      using concurrent_flat_map = utxoz::flatmap::concurrent_flat_map<Key, T,
  ...
  using utxoz::flatmap::concurrent_flat_map;
} // namespace utxoz

#endif // UTXOZ_FLATMAP_CONCURRENT_FLAT_MAP_HPP
