// =============================================================================
// MIGRATION STATUS: This file is being migrated to utxo-db/src/
// Target: utxo-db/src/database_impl.cpp + detail/database_impl.hpp
//
// Legend:
//   // MIGRATED - Already migrated to utxo-db
